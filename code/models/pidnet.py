...
from utils.pidnet_utlis.resnet import basic_block, bottleneck_block, basicblock_expansion, bottleneck_expansion
from utils.pidnet_utlis.model_utils import segmentation_head, DAPPPM, PAPPM, PagFM, Bag, Light_Bag
...
def PIDNet(input_shape=[1024, 2048, 3], m=2, n=3, num_classes=19, planes=64, ppm_planes=96,
    ...
    x_ = segmentation_head(dfm, head_planes, num_classes,8)  # final_layer, 원래의 사이즈로 복구
